package com.test.sharding.repository;

import com.test.sharding.ShardingsphereApp;
import com.test.sharding.config.Constants;
import com.test.sharding.config.audit.AuditEventConverter;
import com.test.sharding.domain.PersistentAuditEvent;
...
import static com.test.sharding.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
